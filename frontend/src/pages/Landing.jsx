    ...
    <div className="relative min-h-screen w-full bg-[#000000] overflow-x-hidden font-sans text-slate-200 selection:bg-blue-500/30 flex flex-col">
        ...
        <div className="max-w-[1440px] mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="font-semibold text-white tracking-tight text-sm">
              InterviewCoach <span className="text-[9px] ml-1 bg-white/10 px-1.5 py-0.5 rounded text-slate-400">BETA</span>
            </span>
          </div>
      ...
      <main className="relative z-20 flex-1 w-full pt-32 pb-24">
        ...
        <section className="px-6 flex flex-col items-center justify-center text-center max-w-5xl mx-auto mb-20">
          <h1 className="text-6xl md:text-7xl lg:text-[84px] font-extrabold tracking-tighter text-white leading-[1.05] mb-6">
            A real interview.<br />
            Not a practice quiz.
          </h1>
        ...
        <section id="system-design" className="px-6 max-w-[1400px] mx-auto mb-32">
          <div className="flex flex-col xl:flex-row items-start xl:items-end justify-between mb-8 gap-6">
            <div>
              <span className="text-[10px] font-mono font-bold uppercase tracking-widest text-slate-400 mb-2 block">
          ...
          <GlassCard className="p-0 overflow-hidden">
            <div className="grid grid-cols-1 lg:grid-cols-12 min-h-[500px]">
              ...
              <div className="lg:col-span-8 p-8 flex flex-col bg-black/40 relative">
                ...
                <div className="flex-1 space-y-6 flex flex-col justify-end pb-12">
                  <div className="flex gap-4 max-w-xl">
                    <div className="w-8 h-8 rounded-full bg-indigo-600 flex items-center justify-center text-white shrink-0"><Terminal size={14} /></div>
                  ...
                  <div className="flex gap-4 max-w-xl self-end flex-row-reverse">
                    <div className="w-8 h-8 rounded-full bg-slate-700 flex items-center justify-center text-white shrink-0"><Mic size={14} /></div>
                    <div className="bg-blue-600 p-4 rounded-2xl rounded-tr-sm text-sm text-white font-medium leading-relaxed shadow-[0_10px_30px_rgba(37,99,235,0.2)]">
                ...
                <div className="absolute bottom-6 left-8 right-8 h-12 bg-white/5 border border-white/10 rounded-full flex items-center px-4 justify-between backdrop-blur-md">
                  ...
                  <span className="text-[10px] font-mono font-bold text-slate-400">Listening... 145 WPM</span>
                  <div className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center text-slate-300"><ArrowRight size={14} /></div>
                </div>
              </div>
              ...
              <div className="lg:col-span-4 border-t lg:border-t-0 lg:border-l border-white/10 bg-[#050508] p-8 flex flex-col justify-between">
                <div>
                  <h3 className="text-[10px] font-bold uppercase tracking-widest text-slate-400 mb-6">Adaptive ELO Engine</h3>
                  <div className="mb-8">
                    <span className="text-5xl font-extrabold text-white tracking-tighter tabular-nums"><AnimatedNumber to={1416} /></span>
                ...
                <div className="mt-8 pt-8 border-t border-white/10">
                  <h3 className="text-[10px] font-bold uppercase tracking-widest text-slate-400 mb-4">Socratic Debugger</h3>
        ...
        <section id="live-coding" className="px-6 max-w-[1400px] mx-auto mb-32">
          <div className="flex flex-col md:flex-row items-start md:items-end justify-between mb-8 gap-4">
            ...
            <div className="flex items-center gap-2">
              <span className="text-[10px] font-mono uppercase tracking-widest text-slate-400 mr-2">Isolated Linux Sandbox</span>
              <div className="flex items-center gap-2 bg-[#050508] border border-white/10 p-1.5 rounded-full">
                ...
                {['Python', 'JavaScript', 'C++', 'Java'].map((lang) => (
                  <button 
                    ...
                    className={`px-4 py-2 rounded-full text-xs font-bold transition-colors ${activeTabIDE === lang ? "bg-white text-black" : "text-slate-400 hover:text-white"}`}
                  >
                    {lang}
                  </button>
                ))}
          ...
          <GlassCard className="p-0 overflow-hidden">
            <div className="grid grid-cols-1 lg:grid-cols-12 min-h-[500px]">
              ...
              <div className="lg:col-span-3 bg-[#050508] border-r border-white/10 p-6 flex flex-col">
                ...
                <h3 className="text-lg font-bold text-white mb-4 leading-tight">Rate Limiter — Token Bucket</h3>
                ...
                <h4 className="text-[10px] font-bold uppercase tracking-widest text-slate-400 mb-3">Constraints</h4>
                ...
                <div className="mt-auto bg-black/50 border border-white/5 p-4 rounded-xl font-mono text-[10px] text-slate-400">
            ...
            <GlassCard className="p-8 h-[380px] flex flex-col justify-between">
              <div className="flex justify-between items-center mb-8">
                <div>
                  ...
                  <span className="text-xl font-bold text-white">Real-time vocal analysis</span>
                </div>
                <div className="flex items-center gap-1.5">
              ...
              <div className="grid grid-cols-4 gap-4">
                <div className="bg-white/5 border border-white/10 p-4 rounded-xl text-center">
                  <span className="block text-2xl font-bold text-white tabular-nums tracking-tighter mb-1">145</span>
                  <span className="text-[9px] font-bold uppercase tracking-widest text-slate-500">WPM</span>
                </div>
                <div className="bg-white/5 border border-white/10 p-4 rounded-xl text-center">
                  <span className="block text-2xl font-bold text-white tabular-nums tracking-tighter mb-1">0.87</span>
                  <span className="text-[9px] font-bold uppercase tracking-widest text-slate-500">Confidence</span>
                </div>
                <div className="bg-white/5 border border-white/10 p-4 rounded-xl text-center">
                  <span className="block text-2xl font-bold text-white tabular-nums tracking-tighter mb-1">2.1s</span>
                  <span className="text-[9px] font-bold uppercase tracking-widest text-slate-500">Latency R/T</span>
                </div>
                <div className="bg-white/5 border border-white/10 p-4 rounded-xl text-center">
                  <span className="block text-2xl font-bold text-white tabular-nums tracking-tighter mb-1">3</span>
            ...
            <GlassCard className="p-8 h-[380px] flex flex-col justify-between">
              <div className="flex justify-between items-start mb-8">
                <div>
                  ...
                  <span className="text-xl font-bold text-white">Diagnostic question dependency tree</span>
                </div>
                <span className="bg-white/10 text-white font-bold text-[10px] px-3 py-1.5 rounded-full uppercase tracking-widest">93 Nodes</span>
              </div>
              ...
              <div className="flex-1 flex items-center justify-center bg-black/30 border border-white/5 rounded-xl mb-6 shadow-inner relative overflow-hidden">
                ...
                <div className="text-center relative z-10">
                  <NetworkIcon />
                  <p className="text-xs text-slate-400 font-mono mt-4">[ Knowledge graph — node-edge visualization ]</p>
              ...
              <div className="flex items-center gap-2 overflow-x-auto scrollbar-hide py-1">
                ...
                <span className="bg-[#111116] border border-white/10 text-white px-3 py-1.5 rounded text-[10px] font-bold whitespace-nowrap shadow-sm">Rate Limiting</span>
                <ArrowRight size={12} className="text-slate-600 shrink-0" />
                <span className="bg-[#111116] border border-white/10 text-white px-3 py-1.5 rounded text-[10px] font-bold whitespace-nowrap shadow-sm">Token Bucket</span>
                <ArrowRight size={12} className="text-slate-600 shrink-0" />
        ...
        <section id="architecture" className="px-6 max-w-[1400px] mx-auto mb-32">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <GlassCard className="p-8 md:p-12 h-full flex flex-col justify-center">
              <span className="text-[10px] font-mono font-bold uppercase tracking-widest text-slate-400 mb-4 block">Engine 05 — Peer Benchmarking</span>
              <h2 className="text-3xl md:text-4xl font-extrabold tracking-tighter text-white mb-4 leading-tight">See where you stand.<br/>Against 9,200 engineers.</h2>
              <p className="text-sm text-slate-400 font-medium leading-relaxed mb-12">Global rank vs. peers in your exact company + level cohort. Percentile updates in real time.</p>
              
              <div className="bg-[#050508] border border-white/10 p-8 rounded-2xl">
                <div className="flex items-end justify-between mb-2">
                  <div>
                    <span className="text-5xl font-extrabold text-white tracking-tighter tabular-nums leading-none">Top 12%</span>
                    <span className="text-[10px] text-slate-500 block mt-2">of 9,200 peers · Google L5 · System Design</span>
                  </div>
                  <div className="text-right">
                    <span className="text-2xl font-bold text-slate-300 tabular-nums leading-none">88<span className="text-sm text-slate-500 font-normal">th</span></span>
                ...
                <div className="mt-8 relative pt-2">
                  ...
                  <div className="flex justify-between text-[9px] text-slate-500 mt-2 font-mono">
                    <span>0th</span>
                    <span className="text-slate-400">— You are here (88th)</span>
                    <span>100th</span>
                  </div>
                </div>
              </div>
            ...
            <div className="p-8 md:p-12 flex flex-col justify-center">
              <span className="text-[10px] font-mono font-bold uppercase tracking-widest text-slate-400 mb-4 block">Engineering Architecture</span>
              <h2 className="text-3xl md:text-4xl font-extrabold tracking-tighter text-white mb-4 leading-tight">Built from scratch.<br/>For production scale.</h2>
              <p className="text-sm text-slate-400 font-medium leading-relaxed mb-10">No generic templates. No low-code platforms. Production-grade infrastructure.</p>
