    ...
    <div className="min-h-screen bg-[#000000] text-slate-100 font-sans selection:bg-blue-500/30 overflow-hidden relative flex flex-col md:flex-row">
      ...
      <div className="relative z-20 flex flex-col md:flex-row w-full min-h-screen">
        ...
        <div className="hidden lg:flex flex-col justify-between w-[45%] p-12 lg:p-16 border-r border-white/[0.06] relative bg-[#000000] overflow-hidden">
          ...
          {/* Honest value-prop card — no numbers here belong to anyone
              specific pre-auth, so none are shown as if they were live
            ...
            <div className="bg-[#050508] border border-white/[0.08] rounded-2xl p-6 backdrop-blur-2xl shadow-[inset_0_1px_0_0_rgba(255,255,255,0.12),_0_20px_40px_-10px_rgba(0,0,0,0.8)]">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <span className="text-xs font-bold text-slate-200 block">Your real ELO trajectory</span>
                    <span className="text-[11px] text-slate-500">Tracked across every scored session — not reset on refresh.</span>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <span className="text-xs font-bold text-slate-200 block">Your diagnosed skill gaps</span>
                    <span className="text-[11px] text-slate-500">Ranked by urgency from your actual past answers.</span>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <span className="text-xs font-bold text-slate-200 block">Where you left off</span>
                    <span className="text-[11px] text-slate-500">Pick up your session history and coding submissions.</span>
                  </div>
                </div>
              </div>
                    ...
                    <form onSubmit={handleLogin} className="space-y-4 relative z-10">
                      ...
                      <div className="space-y-1.5">
                        <div className="flex justify-between items-center ml-1">
                          ...
                          <ComingSoonWrap>
                            <button type="button" disabled className="text-[10px] font-mono font-bold text-slate-600 cursor-not-allowed outline-none">
                              Forgot?
                            </button>
                          </ComingSoonWrap>
                        </div>
                      ...
                      <label className="flex items-center gap-2 pl-1 cursor-pointer select-none">
                        <input
                          ...
                          className="w-3.5 h-3.5 rounded accent-blue-500 bg-[#08080C] border-white/20 cursor-pointer"
                        />
