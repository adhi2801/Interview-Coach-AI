...
import { Search, LogOut, LayoutGrid, History, Settings, Target, ChevronRight, Activity, Zap } from "lucide-react";
...
export default function UserDashboard({ user, onStartNew, onLogout, onNavigateHistory, onStartCoding, onNavigateSettings }) {
  ...
  const targetElo = 1400; // Simulated target for Google L4
  ...
  return (
    <PremiumLayout>
      {/* Dynamic Ambient Glows (Behind the DOM) */}
      ...
      <div className="min-h-screen w-full relative z-10 pb-32">
        <main className="max-w-[1400px] mx-auto p-6 md:p-10 pt-16 lg:pt-24">
            ...
            <div className="grid grid-cols-1 xl:grid-cols-12 gap-6 relative z-10">
                    ...
                    {eloHistory.length > 1 ? (
                      <ResponsiveContainer width="100%" height="100%">
                        <AreaChart data={eloHistory} margin={{ top: 20, right: 20, left: 0, bottom: 0 }}>
                          ...
                          {/* FIXED: Dynamic Y-Axis eliminates the "flat line" bug */}
              ...
              <motion.div variants={itemVars} className="xl:col-span-4 flex flex-col h-[460px]">
                <div className="bg-[#08080A]/80 backdrop-blur-3xl border border-white/[0.08] shadow-[inset_0_1px_0_0_rgba(255,255,255,0.12),_0_30px_60px_rgba(0,0,0,0.6)] rounded-[2rem] p-8 relative overflow-hidden h-full flex flex-col group">
                  ...
                  <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-slate-500 mb-8 flex items-center gap-2">
                  ...
                  <div className="flex items-center gap-5 mb-10">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-blue-400 font-semibold tracking-wide">L4 Software Engineer</p>
                    </div>
                  </div>
                  ...
                  <motion.button 
                    ...
                    className="w-full bg-[#050507] border border-white/[0.1] hover:border-white/[0.2] text-white px-6 py-4 rounded-xl text-sm font-bold transition-all shadow-[inset_0_1px_0_0_rgba(255,255,255,0.05),_0_10px_20px_rgba(0,0,0,0.5)] flex items-center justify-between group/btn mt-6"
                  >
                          ...
                          <tr key={i} onClick={onNavigateHistory} className="hover:bg-white/[0.03] transition-colors group cursor-pointer">
                            ...
                            <td className="px-8 py-5 whitespace-nowrap">
                              <div className="flex items-center gap-3">
                                ...
                                <span className={`text-[10px] font-mono font-bold px-2 py-0.5 rounded border ${isHigh ? 'bg-emerald-500/10 text-emerald-400 border-emerald-500/20' : isLow ? 'bg-rose-500/10 text-rose-400 border-rose-500/20' : 'bg-white/5 text-slate-400 border-white/10'}`}>
                                  {finalElo} ELO
                                </span>
                              </div>
                            </td>
      ...
      {/* ZONE 4: FLOATING MAC-STYLE NAVIGATION DOCK */}
      <motion.div 
